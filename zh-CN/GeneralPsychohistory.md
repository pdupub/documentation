...
从这一章开始，文中的讨论虽然依然会对构建去中心化的网络有所帮助，但却已经将关注的重心转移到对于真实的理解，尝试用最简单的概念描述、解释。

### 时间与光

《形而上学》开篇第一段话中写到”人们总是爱好感觉，而在诸感觉中，尤重视觉“。现在科学也表明，人类由视觉获取的信息占人类获取信息总量的80%以上。视觉即是对于光的感受，所以人类对于外部世界的感受80%是通过光来传递的。
...
从文明伊始，人类就一直用光做为定义时间的基石。时间是什么？**时间由于光这种人类能够感知的速度最快的东西和一切事物碰撞产生的事件持续有序的叠加而使得人类生成的一种感受。** 经典物理中的绝对时空中的时间，是此有序事件的统计学的描述，而从《狭义相对论》开始，对于不同的参照系，不再有统一的统计结果，对于不同的空间位置，也不再有相同的统计结果，时间的定义变为时空中那个点当前的有序事件的最后一个。或者从某种意义上说，《狭义相对论》和《广义相对论》比经典物理更符合观测结果的原因也在于此，因为理论中包含了真实和观测之间由光所产生的影响。甚至从某种含义来说，人类即可以被认为是炭基生命，也可以被认为是光基生命。
